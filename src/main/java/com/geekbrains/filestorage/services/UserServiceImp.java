...
import com.geekbrains.filestorage.repositories.RoleRepository;
import com.geekbrains.filestorage.repositories.UserRepository;
...
public class UserServiceImp implements UserService {
    ...
    public boolean save(SystemUser systemUser) {
        ...
        if(findByUserName(systemUser.getUserName()) != null) return false;
